...
public class OrderSystem {
    // menu file path
    private static final String MENU_FILE_PATH = "menuDetails.csv";
    // order file path
    private static final String ORDER_FILE_PATH = "orderDetails.csv";
...
private static String generateOrderDate() {
    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-MMM");
    Date date = new Date();
